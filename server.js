  // server.js
// --- VERSION 9.2 (Re-enabling Tracking ID) ---
// This version re-enables the 'tracking_id' in the search query.
// This is the final step to ensure the API returns relevant, promotable affiliate products.
...
app.get('/search', async (req, res) => {
    ...
    const performSearch = async () => {
        ...
        const params = {
            ...
            timestamp: new Date().getTime(),
            keywords: keywords,
            tracking_id: TRACKING_ID, // <-- Re-enabled for relevant results
            target_language: 'EN',
        };
