// server.js
// --- VERSION 6.1 (Deployment Version with Hebrew Language Request) ---
// This code reads sensitive keys from environment variables for security.
// It now requests search results in Hebrew.
...
app.get('/search', async (req, res) => {
    ...
    const performSearch = async () => {
        ...
        const params = {
            ...
            timestamp: new Date().getTime(),
            keywords: keywords,
            target_language: 'HE', // --- CHANGE: Requesting results in Hebrew ---
        };
